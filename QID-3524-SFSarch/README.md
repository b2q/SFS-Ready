...
## ![qlogo](https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/qloqo.png) **SFSarch**
...
Output: 
- 'Plots of the log-likelihood objective functions and of forecasts of the estimated volatility processes.'
- 'Estimated parameters for the return and volatility equations.'
Example:
- 'The values of the Log-likelihood function based on the ARCH(6) model for the volatility processes of DAX and FTSE 100 returns.'
- 'Estimated and forecasted volatility processes of DAX and FTSE 100 returns based on an ARCH(6) model. The solid line denotes the unconditional volatility.'
```
