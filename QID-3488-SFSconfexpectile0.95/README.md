...
## ![qlogo](https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/qloqo.png) **SFSconfexpectile0.95**
...
Example: 
- 'Quantile curve (blue) and expectile curve (green) for N(0, 1).'
- 'Theoretical Expectile Curve (black), Estimated Expectile Curve (blue) and 95% Uniform Confidence Bands (red).'
```
